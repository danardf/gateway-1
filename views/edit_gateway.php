		...
		<div class="col-md-12">
			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="text" pattern="[a-zA-Z0-9éèêëàâùûüîïôçœæÉÈÊËÀÂÙÛÜÎÏÔÇŒÆ_\s\-]+" required class="form-control" id="contact" name="contact" value="<?= htmlspecialchars($gateway['contact']) ?>" placeholder="<?= _("Enter the name of the contact.") ?>">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="col-md-12">
			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="text" pattern="[a-zA-Z0-9éèêëàâùûüîïôçœæÉÈÊËÀÂÙÛÜÎÏÔÇŒÆ_\s\-]+" class="form-control" id="description" name="description" value="<?= htmlspecialchars($gateway['description']) ?>" placeholder="<?= _("Enter the description of the gateway.") ?>">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="col-md-12">
			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="email" class="form-control" id="email" name="email" value="<?= htmlspecialchars($gateway['email']) ?>" placeholder="<?= _("Enter the email of the contact.") ?>">
					</div>
				</div>
			</div>
		</div>
...
<div class="element-container">
		...
		<div class="col-md-12">
			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="text" pattern="[a-zA-Z0-9éèêëàâùûüîïôçœæÉÈÊËÀÂÙÛÜÎÏÔÇŒÆ_\s\-]+" class="form-control" id="address" name="address" value="<?= htmlspecialchars($gateway['address']) ?>" placeholder="<?= _("Enter the address") ?>">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-md-12">
			<span id="address-help" class="help-block fpbx-help-block"><?= _("Enter the address") ?></span>
		</div>
	</div>
</div>
<!--END Address-->
		...
		<div class="col-md-12">
			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="text" pattern="\d{3,6}" class="form-control" id="zip" name="zip" value="<?= htmlspecialchars($gateway['zip_code']) ?>" placeholder="<?= _("Enter the ZIP code") ?>">
					</div>
				</div>
			</div>
		</div>
...
<div class="element-container">
		...
		<div class="col-md-12">
			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="text" pattern="[a-zA-Z0-9éèêëàâùûüîïôçœæÉÈÊËÀÂÙÛÜÎÏÔÇŒÆ_\s\-]+" class="form-control" id="city" name="city" value="<?= htmlspecialchars($gateway['city']) ?>" placeholder="<?= _("Enter the city") ?>">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-md-12">
			<span id="city-help" class="help-block fpbx-help-block"><?= _("Enter the city") ?></span>
		</div>
	</div>
</div>
<!--END City-->
...
<div class="element-container">
		...
		<div class="col-md-12">
			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="text" pattern="[a-zA-Z0-9éèêëàâùûüîïôçœæÉÈÊËÀÂÙÛÜÎÏÔÇŒÆ_\s\-]+" class="form-control" id="country" name="country" value="<?= htmlspecialchars($gateway['country']) ?>" placeholder="<?= _("Enter the country") ?>">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-md-12">
			<span id="country-help" class="help-block fpbx-help-block"><?= _("Enter the country") ?></span>
		</div>
	</div>
</div>
<!--END Country-->
		...
		<div class="col-md-12">
			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="text" pattern="^(\d{1,3}\.){3}\d{1,3}(:\d{1,5})?$" required class="form-control" id="gateway" name="gateway" value="<?= htmlspecialchars($gateway['gateway']) ?>" placeholder="<?= _("Ip address of the remote gateway. (Public IP address)") ?>">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="col-md-12">
			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="text" pattern="[A-Za-z0-9_\-]{1,40}" class="form-control" id="accountcode" name="accountcode" value="<?= htmlspecialchars($accountcode) ?>" placeholder="<?= _("Enter the account code.") ?>">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="col-md-12">
			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="number" min="0" class="form-control" id="call_limit" name="call_limit" value="<?= intval($gateway['call_limit']) ?>" placeholder="<?= _("0 = unlimited") ?>">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="col-md-12">
			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="tel" pattern="\d{1,15}" required class="form-control" id="primarydid" name="dids[]" value="<?= htmlspecialchars($gateway['extension']) ?>" readonly="readonly">
					</div>
				</div>
			</div>
		</div>
...
<div id="dids">
<?php
	$existingDids = json_decode($gateway['dids'], true);
	foreach($existingDids as $index => $did):
		if($index === 0) continue;
?>
<div class="did-row">
	<div class="element-container">
